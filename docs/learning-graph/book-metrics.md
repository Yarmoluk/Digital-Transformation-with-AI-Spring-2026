...
|-------------|-------|------|-------|
| Chapters | 10 | [Chapters](../chapters/index.md) | Number of chapter directories |
...
| FAQs | 47 | [FAQ](../faq.md) | Frequently asked questions |
| Quiz Questions | 0 | - | Questions across all chapters |
| MicroSims | 34 | [Simulations](../sims/index.md) | Interactive MicroSims |
...
| Equations | 31 | 18 | LaTeX expressions (inline and display) |
| Total Words | 71,710 | 33,903 | Words in markdown files |
| Links | 230 | 21 | Hyperlinks in markdown format |
| Equivalent Pages | 311 | 159 | Estimated pages (250 words/page + visuals) |
