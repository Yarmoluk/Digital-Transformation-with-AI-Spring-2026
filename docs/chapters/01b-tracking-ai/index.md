---
title: Tracking AI Progress and Trends
description: Understanding how to measure, benchmark, and project AI capabilities through data-driven analysis and visualization
---
...
1. **Investment Timing**: Knowing when AI capabilities will reach certain thresholds helps time investments appropriately
2. **Workforce Planning**: Anticipating AI capabilities helps plan for workforce transformation
3. **Competitive Strategy**: Understanding the pace of change informs competitive positioning
4. **Risk Management**: Projecting AI advancement helps identify both opportunities and threats
5. **Resource Allocation**: Data-driven trend analysis supports better budgeting decisions
...
<iframe src="../../sims/ai-task-horizons/main.html" height="600px" width="100%" scrolling="no" style="border: none;"></iframe>

[View AI Task Horizons Fullscreen](../../sims/ai-task-horizons/main.html){ .md-button }
...
<iframe src="../../sims/ai-doubling-rate/main.html" width="100%" height="520" scrolling="no" style="border: none;"></iframe>

[View AI Doubling Rate Fullscreen](../../sims/ai-doubling-rate/main.html){ .md-button }
...
<iframe src="../../sims/ai-benchmarks-timeline/main.html" height="450px" width="100%" scrolling="no" style="border: none;"></iframe>

[View AI Benchmarks Timeline Fullscreen](../../sims/ai-benchmarks-timeline/main.html){ .md-button }

**Benchmark Evolution:**

1. **Early Era (Pre-2015)**: Simple pattern recognition, image classification
2. **Deep Learning Era (2015-2020)**: Natural language understanding, question answering
3. **LLM Era (2020-Present)**: Professional exams, coding, mathematical reasoning
4. **Current Challenges**: Multi-step reasoning, long-horizon tasks, real-world deployment
...
<iframe src="../../sims/mmlu-timeline/main.html" height="550px" width="100%" scrolling="no" style="border: none;"></iframe>

[View MMLU Timeline Fullscreen](../../sims/mmlu-timeline/main.html){ .md-button }
...
<iframe src="../../sims/lm-arena-timeline/main.html" height="550px" width="100%" scrolling="no" style="border: none;"></iframe>
...
<iframe src="../../sims/ai-pace-accelerating/main.html" height="550px" width="100%" scrolling="no" style="border: none;"></iframe>

[View AI Pace Accelerating Fullscreen](../../sims/ai-pace-accelerating/main.html){ .md-button }

**Drivers of Acceleration:**

1. **More Training Data**: Larger, higher-quality datasets
2. **Better Algorithms**: Transformer architecture improvements, new training techniques
...
<iframe src="../../sims/moores-law/main.html" height="600px" width="100%" scrolling="no" style="border: none;"></iframe>

[View Moore's Law Fullscreen](../../sims/moores-law/main.html){ .md-button }
...
<iframe src="../../sims/power-wall/main.html" height="605px" width="100%" scrolling="no" style="border: none;"></iframe>

[View Power Wall Fullscreen](../../sims/power-wall/main.html){ .md-button }
...
<iframe src="../../sims/timeline/timeline-v1.html" height="600px" width="100%" scrolling="no" style="border: none;"></iframe>

[View Deep Learning Timeline Fullscreen](../../sims/timeline/timeline-v1.html){ .md-button }
...
<iframe src="../../sims/projecting-ai/main.html" width="100%" height="550" scrolling="no" style="border: none;"></iframe>

[View Projecting AI Fullscreen](../../sims/projecting-ai/main.html){ .md-button }
...
!!! warning "Projections Are Not Predictions"
...
1. **Plan for Accelerating Change**: AI capabilities may advance faster than intuition suggests
2. **Monitor Key Benchmarks**: Track METR task horizons, MMLU scores, and arena rankings
3. **Scenario Planning**: Prepare for multiple possible futures (see Four Futures framework)
4. **Pilot Projects**: Start experimenting with AI for tasks approaching current capability thresholds
5. **Workforce Development**: Invest in human-AI collaboration skills

### For Technology Strategy

1. **Infrastructure Planning**: Anticipate computational requirements for AI deployment
2. **Data Strategy**: Build and curate data assets that will be valuable for AI applications
3. **Vendor Evaluation**: Understand how different AI providers are positioned on capability curves
4. **Build vs. Buy**: Use capability projections to decide when to adopt vs. wait

### For Risk Management

1. **Competitive Disruption**: Assess how advancing AI might disrupt your industry
2. **Automation Risk**: Identify roles and processes most likely to be affected
3. **Security Considerations**: More capable AI brings both opportunities and risks
4. **Dependency Management**: Consider reliance on AI providers and capability trajectories
...
1. METR. (2025). *Measuring AI Ability to Complete Long Tasks*. https://metr.org/blog/2025-03-19-measuring-ai-ability-to-complete-long-tasks/
2. Hendrycks, D., et al. (2021). *Measuring Massive Multitask Language Understanding*. ICLR.
3. Moore, G. (1965). *Cramming More Components onto Integrated Circuits*. Electronics.
